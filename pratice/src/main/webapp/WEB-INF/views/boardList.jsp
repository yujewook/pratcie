  ...
  <div class="board-container">
    ...
    <table>
      ...
      <c:forEach var="boardDto" items="${boardDto}">
        <tr>
          ...
          <td class="title"><a href="<c:url value="/board/select?bno=${boardDto.bno}&page=${ph.page}&pageSize=${ph.pageSize}"/>">${boardDto.title}</a></td>
    ...
    <div class="paging-container">
      <div class="paging">
        ...
        <c:if test="${ph.totalCount!=null && ph.totalCount!=0}">
